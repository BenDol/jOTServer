...
<stripes:layout-render name="/WEB-INF/template/default/main.jsp">
    <stripes:layout-component name="title"><fmt:message key="/CreateAccount.action.title"/></stripes:layout-component>
    <stripes:layout-component name="contents">
        <h2><fmt:message key="/CreateAccount.action.title" /></h2>

        <p><stripes:messages/></p>
        <stripes:form beanclass="org.jotserver.web.CreateAccountActionBean" method="post" focus="">
            <table>
                <tr>
                    <td colspan="2">
                        <stripes:errors />
                ...
                <tr>
                    <td><stripes:label for="passwordRepeat" />:</td>
